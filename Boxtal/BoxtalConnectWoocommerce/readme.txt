...
1 free app, 15 carriers and no contract or minimum order quantity.
...
* Have a look here: https://help.boxtal.com/hc/fr/articles/360012794237-Guide-de-paramétrage-WooCommerce

== Screenshots ==

1. Connect your online store in 1 click
2. Save time with an optimized setup
3. Pick your carrier offers
4. Get your shipping labels
5. Keep track of your packages
6. If needed, create a return label

== Changelog ==

= 1.2.15 =
* Correction d'un bug empêchant l'affichage de l'adresse d'un point relais au passage d'une commande
* Correction d'un problème de compatibilité avec le module colissimo
* Correction d'un bug empêchant la sauvegarde des réseaux de points relais disponible pour une méthode de livraison 
* Correction d'un bug à la synchronisation des commandes avec des articles à variation
