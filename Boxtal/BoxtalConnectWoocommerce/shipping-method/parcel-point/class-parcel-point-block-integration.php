...
class Parcel_Point_Block_Integration implements IntegrationInterface {
	...
	public function initialize() {
		...
		wp_enqueue_script( 'bw_polyfills', $assets_path . '/js/polyfills.min.js', array(), '1.3.0', false );
		wp_enqueue_script( 'bw_mapbox_gl', $assets_path . '/js/mapbox-gl.js', array( 'bw_polyfills' ), '1.3.0', false );
		wp_enqueue_script( 'bw_shipping', $assets_path . '/js/parcel-point.min.js', array( 'bw_mapbox_gl', 'bw_polyfills', 'jquery-core', 'wp-hooks' ), '1.3.0', false );
		wp_enqueue_style( 'bw_mapbox_gl', $assets_path . '/css/mapbox-gl.min.css', array(), '1.3.0' );
		wp_enqueue_style( 'bw_parcel_point', $assets_path . '/css/parcel-point.css', array(), '1.3.0' );
